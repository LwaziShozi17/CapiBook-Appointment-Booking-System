    ...
    <div className="px-8 py-8">
      ...
      {isSystemAdmin && summary && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            { label: 'Total Booked', value: summary.totalBooked, color: 'text-gray-900' },
            { label: 'Pending', value: summary.totalPending, color: 'text-yellow-600' },
            { label: 'Confirmed', value: summary.totalConfirmed, color: 'text-blue-600' },
            { label: 'Completed', value: summary.totalCompleted, color: 'text-green-600' },
            { label: 'Cancelled', value: summary.totalCancelled, color: 'text-red-600' },
            { label: 'No-Show', value: summary.totalNoShow, color: 'text-gray-500' },
            { label: 'Rescheduled', value: summary.totalRescheduled, color: 'text-purple-600' },
          ].map((stat) => (
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 col-span-2 md:col-span-1 flex flex-col justify-center">
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <h2 className="text-sm font-semibold text-gray-700">Recent Appointments</h2>
          <button
        ...
        {recent.length === 0 ? (
          <div className="px-5 py-8 text-center text-sm text-gray-400">No appointments yet.</div>
        ) : (
            ...
            <tbody>
              {recent.map((appt) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-gray-500">{appt.appointmentDate}</td>
